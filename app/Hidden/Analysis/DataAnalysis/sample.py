...
mergedData = back.mergeData(data1, data2)
uniqueData = mergedData.drop_duplicates()

# We can use this to create our list of nodes
nodes = [{"id": str(unique_set[0]), "name": unique_set[0]} for unique_set in uniqueData.values]
