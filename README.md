...
## Testing Locally
To run the application all that needs to be done is run the following commands:
	npm install
This will install all the required dependencies in a folder called 'node_modules'

Once everything is isntalled we can run
	npm start
